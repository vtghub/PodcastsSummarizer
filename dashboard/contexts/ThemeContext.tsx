...
const THEME_VARS: Record<ThemeKey, Record<string, string>> = {
  "anthropic-light": {
    ...
    "--acc-ring": "rgba(194,65,12,0.12)",
    "--shadow-card": "0 1px 4px rgba(0,0,0,0.06)", "--shadow-card-hov": "0 6px 20px rgba(0,0,0,0.10)",
    "--shadow-nav": "0 1px 0 #E2DDD6",
  ...
  "midnight": {
    ...
    "--acc-ring": "rgba(99,102,241,0.18)",
    "--shadow-card": "0 1px 4px rgba(0,0,0,0.3)", "--shadow-card-hov": "0 6px 24px rgba(0,0,0,0.45)",
    "--shadow-nav": "0 1px 0 #1E293B",
  ...
  "aurora": {
    ...
    "--acc-ring": "rgba(6,182,212,0.18)",
    "--shadow-card": "0 1px 4px rgba(0,0,0,0.3)", "--shadow-card-hov": "0 6px 24px rgba(0,0,0,0.45)",
    "--shadow-nav": "0 1px 0 #0D2D50",
  ...
  "dusk": {
    ...
    "--acc-ring": "rgba(168,85,247,0.18)",
    "--shadow-card": "0 1px 4px rgba(0,0,0,0.3)", "--shadow-card-hov": "0 6px 24px rgba(0,0,0,0.45)",
    "--shadow-nav": "0 1px 0 #2A1E4A",
  ...
  "forest": {
    ...
    "--acc-ring": "rgba(16,185,129,0.18)",
    "--shadow-card": "0 1px 4px rgba(0,0,0,0.3)", "--shadow-card-hov": "0 6px 24px rgba(0,0,0,0.45)",
    "--shadow-nav": "0 1px 0 #122A1C",
